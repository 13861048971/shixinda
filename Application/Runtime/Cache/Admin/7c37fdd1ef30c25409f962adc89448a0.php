...
<?php if($tab != 1): if($error): ?><div class="alert alert-danger"><?php echo ($error); ?></div>
	<?php else: ?>
		<form class="form-inline search clearfix">
			<div class="pull-left time-buttons">
				<label>日期:</label> <?php echo w('form/node', $selectDate);?>
			</div>
		</form>
		<div id="order-chart" style="height:400px">
			<textarea class="hide"><?php echo ($sData); ?></textarea>
		</div><?php endif; ?>
  <?php else: ?>
	 <div title="地区分布" id="region-chart" style="height:400px">
		<textarea class="hide"><?php echo ($sData); ?></textarea>
	 </div><?php endif; ?>
</div>
<link rel="stylesheet" type="text/css" href="/Public/js/lib/daterangepicker/daterangepicker-bs3.css" />
<script type="text/javascript" src="/Public/js/lib/daterangepicker/moment.min.js"></script><script type="text/javascript" src="/Public/js/lib/daterangepicker/daterangepicker.js"></script><script type="text/javascript" src="/Public/js/lib/echarts/echarts.js"></script><script type="text/javascript" src="/Public/js/admin/count.js"></script>
		</div>
	</div>
</div>
<div class="footer">
