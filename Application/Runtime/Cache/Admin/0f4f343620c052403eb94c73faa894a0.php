...
<body>
    <form class="form-horizontal ajaxSubmit role-form" action="<?php echo u('contentCateEdit');?>" method="post">
  <div class="form-group">
    <label class="col-sm-2 control-label"><b class="red">*</b>分类名称:</label>
    <div class="col-sm-8">
