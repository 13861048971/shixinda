...
<div class="table-responsive">
	<table class="table table-striped">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
			...
			<td class="handle">  
				<?php if($v['id'] > 0): ?><a class="dialog edit" dialog-lg="true" href="#" url="<?php echo u('roleEdit','id=' . $v['id']);?>">编辑</a>
					<a class="del" href="#" url="<?php echo u('roleDel','id=' . $v['id']);?>">删除</a>
				<?php else: ?>
					<a class="lock"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span> 锁定</a><?php endif; ?>
			</td>
		</tr><?php endforeach; endif; ?>
	</table>
	<div><?php echo ($pageVar); ?></div>
</div>
<script type="text/javascript" src="/Public/js/admin/role.js"></script>
		</div>
	</div>
</div>
<div class="footer">
