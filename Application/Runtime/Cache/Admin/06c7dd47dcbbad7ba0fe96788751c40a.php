...
<div class="table-responsive shrink user">
	...
	<form action="" class="form-inline search clearfix" method="GET">
		<input type="text" class="form-control" name="name" placeholder="请输入连接名" value="<?php echo ($linkName); ?>" />
	...
	<table class="table table-striped user-list">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
			...
			<td class="handle">
				<a class="dialog edit"  href="#" url="<?php echo u('friendLinkEdit','id=' . $v['id']);?>">编辑</a>|
				<a class="ajaxDel del" href="#" url="<?php echo u('friendLinkDel','id=' . $v['id']);?>">删除</a>
			</td>
